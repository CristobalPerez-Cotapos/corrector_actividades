...
class VerificarClaseAnimal(unittest.TestCase):
    ...
    def test_no_puede_instanciarse(self):
        self.assertRaises(TypeError, Animal, 15)
...
class VerificarClasePerro(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.perro = Perro(nombre='p', raza='a', peso=3)
    ...
    def test_energia_gastada_correcto(self):
        self.assertEqual(self.perro.energia_gastada_por_desplazamiento(), 15)
    ...
    def test_peso(self):
        self.assertEqual(self.perro.peso, 3)

    def test_desplazarse(self):
        self.assertEqual(self.perro.energia, 100)
        self.perro.desplazarse()
        self.assertEqual(self.perro.energia, 85)

    def test_metodo_ladrar(self):
        self.assertIsInstance(self.perro.ladrar, types.MethodType)

    def test_metodo_retorno_ladrar(self):
        self.assertIsInstance(self.perro.ladrar(), str)

    def test_retorno_desplazarse(self):
        self.assertEqual(self.perro.desplazarse(), 'caminando...')
...
class VerificarClasePez(unittest.TestCase):
    ...
    def test_retorno_desplazarse(self):
        self.assertEqual(self.pez.desplazarse(), 'nadando...')

    def test_metodo_nadar(self):
        self.assertIsInstance(self.pez.nadar, types.MethodType)

    def test_metodo_retorno_nadar(self):
        self.assertIsInstance(self.pez.nadar(), str)
...
if __name__ == '__main__':
    print("El archivo test.py se está ejecutando correctamente.")
